...
<!-- Mirrored from demo.hasthemes.com/selena-preview/selena/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Sep 2020 06:21:35 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="order-summary-content">
                                ...
                                <div class="order-summary-table table-responsive text-center">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="single-product.php">Suscipit Vestibulum <strong> × 1</strong></a></td>
                                                <td>$165.00</td>
                                            </tr>
                                            <tr>
                                                <td><a href="single-product.php">Ami Vestibulum suscipit <strong> × 4</strong></a></td>
                                                <td>$165.00</td>
                                            </tr>
                                            <tr>
                                                <td><a href="single-product.php">Vestibulum suscipit <strong> × 2</strong></a></td>
                                                <td>$165.00</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                        ...
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="paypalpayment" name="paymentmethod" value="paypal"
                                                    class="custom-control-input" />
                                                <label class="custom-control-label" for="paypalpayment">Paypal <img src="assets/img/paypal-card.jpg"
...
<!-- Mirrored from demo.hasthemes.com/selena-preview/selena/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Sep 2020 06:21:37 GMT -->
</html>