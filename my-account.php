...
<!-- Mirrored from demo.hasthemes.com/selena-preview/selena/my-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Sep 2020 06:21:16 GMT -->
<head>
    <meta charset="utf-8">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Pending</td>
                                                                <td>$3000</td>
                                                                <td><a href="cart.php" class="btn btn__bg btn__sqr">View</a></td>
                                                            </tr>
                                                            <tr>
                                                                <td>2</td>
                                                                <td>July 22, 2018</td>
                                            ...
                                            <div class="myaccount-content">
                                                ...
                                                <div class="account-details-form">
                                                    <form action="#">
                                                        ...
                                                        <div class="single-input-item">
                                                            <button class="btn btn__bg btn__sqr">Save Changes</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
